...
The LOCKSS system requires a **64-bit Linux** host running [**systemd**](https://www.freedesktop.org/wiki/Software/systemd/), an operating system which supports [**snapd**](https://snapcraft.io/docs/installing-snapd), **[Docker](https://www.docker.com/) 18.09 or better** and the lightweight kubernetes runtime [**microk8s**](https://microk8s.io/).
...
To check installed pre-requisites, use the script [`scripts/check-sys`](check-sys), which will attempt to find and install missing elements.
